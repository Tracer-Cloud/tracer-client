...
pub static ref TARGETS: Vec<Target> = [
    ...
    Target::new(TargetMatch::ProcessName("STAR".to_string()))
        .set_display_name(DisplayName::Name("STAR".to_string())),
    // bowtie section
    Target::new(TargetMatch::ProcessName("bowtie2".to_string()))
        .set_display_name(DisplayName::Name("bowtie-2".to_string())),
    Target::new(TargetMatch::ProcessName("bowtie2-build-s".to_string()))
        .set_display_name(DisplayName::Name("bowtie2-build-s".to_string())),
    Target::new(TargetMatch::ProcessName("bowtie2-align-s".to_string()))
        .set_display_name(DisplayName::Name("bowtie2-align-s".to_string())),
    Target::new(TargetMatch::CommandContains(CommandContainsStruct {
    ...
    Target::new(TargetMatch::ProcessName("bwa".to_string()))
        .set_display_name(DisplayName::Name("bwa".to_string())),
    Target::new(TargetMatch::ProcessName("salmon".to_string()))
        .set_display_name(DisplayName::Name("salmon".to_string())),
    ...
    Target::new(TargetMatch::ProcessName("stringtie".to_string()))
        .set_display_name(DisplayName::Name("stringtie".to_string())),
    Target::new(TargetMatch::ProcessName("featureCounts".to_string()))
        .set_display_name(DisplayName::Name("featureCounts".to_string())),
    Target::new(TargetMatch::ProcessName("HOMER".to_string()))
        .set_display_name(DisplayName::Name("HOMER".to_string())),
    Target::new(TargetMatch::ProcessName("samtools".to_string()))
        .set_display_name(DisplayName::Name("samtools".to_string())),
    Target::new(TargetMatch::ProcessName("seasmoke".to_string()))
        .set_display_name(DisplayName::Name("seasmoke".to_string())),
    Target::new(TargetMatch::ProcessName("alphafold".to_string()))
        .set_display_name(DisplayName::Name("alphafold".to_string())),
    Target::new(TargetMatch::ProcessName("bedtools".to_string()))
        .set_display_name(DisplayName::Name("bedtools".to_string())),
    Target::new(TargetMatch::ProcessName("deeptools".to_string()))
        .set_display_name(DisplayName::Name("deeptools".to_string())),
    Target::new(TargetMatch::ProcessName("macs3".to_string()))
        .set_display_name(DisplayName::Name("macs3".to_string())),
    Target::new(TargetMatch::ProcessName("plotCoverage".to_string()))
        .set_display_name(DisplayName::Name("plotCoverage".to_string())),
    Target::new(TargetMatch::ProcessName("plotPCA".to_string()))
        .set_display_name(DisplayName::Name("plotPCA".to_string())),
    Target::new(TargetMatch::ProcessName("plotFingerprint".to_string()))
        .set_display_name(DisplayName::Name("plotFingerprint".to_string())),
    Target::new(TargetMatch::ProcessName("MACS33".to_string()))
        .set_display_name(DisplayName::Name("MACS33".to_string())),
    Target::new(TargetMatch::ProcessName("Genrich".to_string()))
        .set_display_name(DisplayName::Name("Genrich".to_string())),
    Target::new(TargetMatch::ProcessName("TopHat".to_string()))
        .set_display_name(DisplayName::Name("TopHat".to_string())),
    Target::new(TargetMatch::ProcessName("JAMM".to_string()))
        .set_display_name(DisplayName::Name("JAMM".to_string())),
    ...
    Target::new(TargetMatch::ProcessName("PEAR".to_string()))
        .set_display_name(DisplayName::Name("PEAR".to_string())),
    Target::new(TargetMatch::ProcessName("Trimmomatic".to_string()))
        .set_display_name(DisplayName::Name("Trimmomatic".to_string())),
    Target::new(TargetMatch::ProcessName("sra-toolkit".to_string()))
        .set_display_name(DisplayName::Name("sra-toolkit".to_string())),
    ...
    Target::new(TargetMatch::ProcessName("cutadapt".to_string()))
        .set_display_name(DisplayName::Name("cutadapt".to_string())),
    Target::new(TargetMatch::ProcessName("cellranger".to_string()))
        .set_display_name(DisplayName::Name("cellranger".to_string())),
    Target::new(TargetMatch::ProcessName("STATsolo".to_string()))
        .set_display_name(DisplayName::Name("STATsolo".to_string())),
    Target::new(TargetMatch::ProcessName("scTE".to_string()))
        .set_display_name(DisplayName::Name("scTE".to_string())),
    Target::new(TargetMatch::ProcessName("scanpy".to_string()))
        .set_display_name(DisplayName::Name("scanpy".to_string())),
    Target::new(TargetMatch::ProcessName("Seurat".to_string()))
        .set_display_name(DisplayName::Name("Seurat".to_string())),
    Target::new(TargetMatch::ProcessName("LIGER".to_string()))
        .set_display_name(DisplayName::Name("LIGER".to_string())),
    Target::new(TargetMatch::ProcessName("SC3".to_string()))
        .set_display_name(DisplayName::Name("SC3".to_string())),
    Target::new(TargetMatch::ProcessName("Louvain".to_string()))
        .set_display_name(DisplayName::Name("Louvain".to_string())),
    Target::new(TargetMatch::ProcessName("Leiden".to_string()))
        .set_display_name(DisplayName::Name("Leiden".to_string())),
    Target::new(TargetMatch::ProcessName("Garnett".to_string()))
        .set_display_name(DisplayName::Name("Garnett".to_string())),
    Target::new(TargetMatch::ProcessName("Monocle".to_string()))
        .set_display_name(DisplayName::Name("Monocle".to_string())),
    Target::new(TargetMatch::ProcessName("Harmony".to_string()))
        .set_display_name(DisplayName::Name("Harmony".to_string())),
    Target::new(TargetMatch::ProcessName("PAGA".to_string()))
        .set_display_name(DisplayName::Name("PAGA".to_string())),
    Target::new(TargetMatch::ProcessName("Palantir".to_string()))
        .set_display_name(DisplayName::Name("Palantir".to_string())),
    Target::new(TargetMatch::ProcessName("velocity".to_string()))
        .set_display_name(DisplayName::Name("velocity".to_string())),
    Target::new(TargetMatch::ProcessName("CellPhoneDB".to_string()))
        .set_display_name(DisplayName::Name("CellPhoneDB".to_string())),
    Target::new(TargetMatch::ProcessName("CellChat".to_string()))
        .set_display_name(DisplayName::Name("CellChat".to_string())),
    Target::new(TargetMatch::ProcessName("NicheNet".to_string()))
        .set_display_name(DisplayName::Name("NicheNet".to_string())),
    Target::new(TargetMatch::ProcessName("FIt-SNE".to_string()))
        .set_display_name(DisplayName::Name("FIt-SNE".to_string())),
    Target::new(TargetMatch::ProcessName("umap".to_string()))
        .set_display_name(DisplayName::Name("umap".to_string())),
    Target::new(TargetMatch::ProcessName("bbmap".to_string()))
        .set_display_name(DisplayName::Name("bbmap".to_string())),
    Target::new(TargetMatch::ProcessName("cuffdiff".to_string()))
        .set_display_name(DisplayName::Name("cuffdiff".to_string())),
    Target::new(TargetMatch::ProcessName("RNA-SeQC".to_string()))
        .set_display_name(DisplayName::Name("RNA-SeQC".to_string())),
    ...
    Target::new(TargetMatch::ProcessName("Trimgalore".to_string()))
        .set_display_name(DisplayName::Name("Trimgalore".to_string())),
    Target::new(TargetMatch::ProcessName("UCHIME".to_string())).set_display_name(DisplayName::Name("UCHIME".to_string())),
    Target::new(TargetMatch::ProcessName("Erange".to_string())).set_display_name(DisplayName::Name("Erange".to_string())),
    Target::new(TargetMatch::ProcessName("X-Mate".to_string())).set_display_name(DisplayName::Name("X-Mate".to_string())),
    Target::new(TargetMatch::ProcessName("SpliceSeq".to_string())).set_display_name(DisplayName::Name("SpliceSeq".to_string())),
    Target::new(TargetMatch::ProcessName("casper".to_string())).set_display_name(DisplayName::Name("casper".to_string())),
    Target::new(TargetMatch::ProcessName("DESeq".to_string())).set_display_name(DisplayName::Name("DESeq".to_string())),
    Target::new(TargetMatch::ProcessName("EdgeR".to_string())).set_display_name(DisplayName::Name("EdgeR".to_string())),
    Target::new(TargetMatch::ProcessName("bamSummary".to_string())).set_display_name(DisplayName::Name("bamSummary".to_string())),
    Target::new(TargetMatch::ProcessName("kallisto".to_string())).set_display_name(DisplayName::Name("kallisto".to_string())),
    Target::new(TargetMatch::ProcessName("pairtools".to_string())).set_display_name(DisplayName::Name("pairtools".to_string())),
    Target::new(TargetMatch::ProcessName("HiCExplorer".to_string())).set_display_name(DisplayName::Name("HiCExplorer".to_string())),
    Target::new(TargetMatch::ProcessName("GITAR".to_string())).set_display_name(DisplayName::Name("GITAR".to_string())),
    Target::new(TargetMatch::ProcessName("TADbit".to_string())).set_display_name(DisplayName::Name("TADbit".to_string())),
    Target::new(TargetMatch::ProcessName("Juicer".to_string())).set_display_name(DisplayName::Name("Juicer".to_string())),
    Target::new(TargetMatch::ProcessName("HiC-Pro".to_string())).set_display_name(DisplayName::Name("HiC-Pro".to_string())),
    Target::new(TargetMatch::ProcessName("cooler".to_string())).set_display_name(DisplayName::Name("cooler".to_string())),
    Target::new(TargetMatch::ProcessName("cooltools".to_string())).set_display_name(DisplayName::Name("cooltools".to_string())),
    Target::new(TargetMatch::ProcessName("runHiC".to_string())).set_display_name(DisplayName::Name("runHiC".to_string())),
    Target::new(TargetMatch::ProcessName("HTSlib".to_string())).set_display_name(DisplayName::Name("HTSlib".to_string())),
    Target::new(TargetMatch::ProcessName("htslib".to_string())).set_display_name(DisplayName::Name("htslib".to_string())),
    Target::new(TargetMatch::ProcessName("zlib".to_string())).set_display_name(DisplayName::Name("zlib".to_string())),
    Target::new(TargetMatch::ProcessName("libbz2".to_string())).set_display_name(DisplayName::Name("libbz2".to_string())),
    Target::new(TargetMatch::ProcessName("liblzma".to_string())).set_display_name(DisplayName::Name("liblzma".to_string())),
    Target::new(TargetMatch::ProcessName("libcurl".to_string())).set_display_name(DisplayName::Name("libcurl".to_string())),
    Target::new(TargetMatch::ProcessName("libdeflate".to_string())).set_display_name(DisplayName::Name("libdeflate".to_string())),
    Target::new(TargetMatch::ProcessName("ncurses".to_string())).set_display_name(DisplayName::Name("ncurses".to_string())),
    Target::new(TargetMatch::ProcessName("pthread".to_string())).set_display_name(DisplayName::Name("pthread".to_string())),
    ...
    Target::new(TargetMatch::BinPathStartsWith("/opt/conda/bin".to_string()))
        ...
        .set_display_name(DisplayName::Name("/opt/conda/bin".to_string())),
    Target::new(TargetMatch::CommandContains(CommandContainsStruct {
        process_name: Some("java".to_string()),

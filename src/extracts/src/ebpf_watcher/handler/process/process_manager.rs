use crate::ebpf_watcher::handler::process::extract_process_data::ExtractProcessData;
use crate::ebpf_watcher::handler::process::process_utils::create_short_lived_process_properties;
use crate::ebpf_watcher::handler::process::types::process_result::ProcessResult;
use crate::ebpf_watcher::handler::process::types::process_state::ProcessState;
use chrono::Utc;
...
mod tests {
    ...
    async fn test_find_matching_processes_parent_match_with_force_ancestor_false() {
        ...
        let process_manager = ProcessManager::new(target_manager, log_recorder);
        let mut processes_from_state = process_manager
            .get_state_mut()
            .await
            .get_processes();

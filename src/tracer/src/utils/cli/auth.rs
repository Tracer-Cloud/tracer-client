...
fn get_login_url(platform: &str, is_development_environment: bool) -> String {
...
fn get_signup_url(platform: &str, is_development_environment: bool) -> String {
    get_url_based_on_platform_and_environment(
        platform,
        is_development_environment,
        SIGNUP_URL_LOCAL,
...
pub fn get_auth_redirect_url(platform: &str, is_development_environment: bool) -> String {
    get_url_based_on_platform_and_environment(
        platform,
        is_development_environment,

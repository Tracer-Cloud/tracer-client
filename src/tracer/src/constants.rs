...
pub const EVENT_FORWARD_ENDPOINT_DEV: &str = "https://api.sandbox.tracer.cloud/api/public/events-forward"; // TODO change to dev endpoint when ready
pub const EVENT_FORWARD_ENDPOINT_PROD: &str = "https://api.sandbox.tracer.cloud/api/public/events-forward";

...
pub const EVENT_FORWARD_ENDPOINT_DEV: &str = "https://dev.sandbox.tracer.cloud/api/events-forward";
pub const EVENT_FORWARD_ENDPOINT_PROD: &str = "https://sandbox.tracer.cloud/api/events-forward";

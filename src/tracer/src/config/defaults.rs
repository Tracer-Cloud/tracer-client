...
use crate::constants::{
    ...
    BATCH_SUBMISSION_RETRY_DELAY_MS, DEFAULT_API_KEY, EVENT_FORWARD_ENDPOINT_DEV,
    EVENT_FORWARD_ENDPOINT_PROD, PROCESS_METRICS_SEND_INTERVAL_MS, PROCESS_POLLING_INTERVAL_MS,
};
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            event_forward_endpoint_dev: Some(EVENT_FORWARD_ENDPOINT_DEV.to_string()),
            event_forward_endpoint_prod: Some(EVENT_FORWARD_ENDPOINT_PROD.to_string()),
        }
    }
}
